...
public class AttachedWindowAssigner<WID extends Window, T>
    extends WindowAssigner<WindowedElement<WID, T>, AttachedWindow<WID>>
{
  @Override
  public Collection<AttachedWindow<WID>>
  assignWindows(WindowedElement<WID, T> element,
                long timestamp,
  ...
  @Override
  public Trigger<WindowedElement<WID, T>, AttachedWindow<WID>>
